...
4. Relevante Dimensionen pruefen (nicht immer alle):
   ...
   **KI-Tauglichkeit (Standard, BOO-7):** 8 Checks (4 Prinzipien + 4 Anti-Patterns) aus Schrader Kap. 4. Referenz: `bootstrapping/references/ki-architektur-prinzipien.md`. Detail: [references/dimensions-detail.md §9](references/dimensions-detail.md).
