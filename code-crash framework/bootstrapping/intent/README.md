...
Skill liegt unter `~/.claude/skills/intent/` (lokal) bzw. `bootstrapping/intent/` im Repo `vibercoder79/claudecodeskills`. Nach dem Setup-Script (`setup.sh`) ist er automatisch aktiviert.
