...
Skill lives under `~/.claude/skills/intent/` (locally) or `bootstrapping/intent/` in the `vibercoder79/claudecodeskills` repo. After running the setup script (`setup.sh`) it's activated automatically.
