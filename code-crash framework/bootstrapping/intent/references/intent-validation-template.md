...
Vergleich des Drafts gegen das Londoner-Team-Beschwerde-Beispiel (siehe [intent-examples.md](../bootstrapping/intent/references/intent-examples.md) §1).
...
Comparison of the draft against the London-team complaint example (see [intent-examples.md](../bootstrapping/intent/references/intent-examples.md) §1).
